...
_CLK(CLK_M_ICN_LMI,	&clkgena0,    0, CLK_ALWAYS_ENABLED),
_CLK(CLK_M_VID_DMU_0,	&clkgena0,    0, 0),
_CLK(CLK_M_VID_DMU_1,	&clkgena0,    0, 0),
_CLK(CLK_M_A9_EXT2F,	&clkgena0,    200000000, CLK_ALWAYS_ENABLED),
_CLK_P(CLK_M_A9_EXT2F_DIV2, &clkgena0, 30000000,
	CLK_ALWAYS_ENABLED, &clk_clocks[CLK_M_A9_EXT2F]),
...
_CLK(CLK_M_TX_ICN_DMU_0, &clkgena0, 333333333, CLK_ALWAYS_ENABLED),
_CLK(CLK_M_TX_ICN_DMU_1, &clkgena0, 333333333, CLK_ALWAYS_ENABLED),
_CLK(CLK_M_TX_ICN_TS,	&clkgena0,  333333333, CLK_ALWAYS_ENABLED),
...
_CLK(CLK_M_PROC_SC,    &clkgena1,   450000000, CLK_ALWAYS_ENABLED),
_CLK(CLK_M_TP,	       &clkgena1,   400000000, CLK_ALWAYS_ENABLED),
_CLK(CLK_M_RX_ICN_DMU_0, &clkgena1, 450000000, 0),
_CLK(CLK_M_RX_ICN_DMU_1, &clkgena1, 450000000, 0),
_CLK(CLK_M_RX_ICN_TS,    &clkgena1, 450000000, CLK_ALWAYS_ENABLED),
_CLK(CLK_M_RX_ICN_VDP_0, &clkgena1, 450000000, 0),
_CLK(CLK_M_PRV_T1_BUS,   &clkgena1,  50000000, 0),
_CLK(CLK_M_ICN_REG_12,   &clkgena1, 200000000, CLK_ALWAYS_ENABLED),
_CLK(CLK_M_ICN_REG_10,   &clkgena1, 200000000, CLK_ALWAYS_ENABLED),
_CLK(CLK_M_ICN_ST231,    &clkgena1,   0,    0),
_CLK(CLK_M_FVDP_PROC_ALT,  &clkgena1, 0, CLK_RATE_PROPAGATES),
_CLK(CLK_M_ICN_REG_13,     &clkgena1, 0, CLK_ALWAYS_ENABLED),
...
_CLK(CLK_M_VTAC_MAIN_PHY, &clkgena2, 744000000, CLK_ALWAYS_ENABLED),
_CLK(CLK_M_VTAC_AUX_PHY,  &clkgena2, 248000000, CLK_ALWAYS_ENABLED),
_CLK(CLK_M_STAC_PHY,    &clkgena2,   800000000, CLK_ALWAYS_ENABLED),
_CLK(CLK_M_STAC_SYS,    &clkgena2,   400000000, CLK_ALWAYS_ENABLED),
...
_CLK(CLK_M_BDISP_0, &clkgena2, 400000000, CLK_ALWAYS_ENABLED),
_CLK(CLK_M_BDISP_1, &clkgena2, 400000000, CLK_ALWAYS_ENABLED),
_CLK(CLK_M_ICN_BDISP,  &clkgena2, 320000000, 0),
_CLK(CLK_M_ICN_COMPO,  &clkgena2, 320000000, CLK_ALWAYS_ENABLED),
_CLK(CLK_M_ICN_VDP_2,  &clkgena2, 320000000, 0),
_CLK(CLK_M_ICN_REG_14, &clkgena2, 200000000, CLK_ALWAYS_ENABLED),
