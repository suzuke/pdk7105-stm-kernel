...
/* This should be handle per output driver (where the constraints are **/
static uint32_t last_kernel_compid = MTT_CH_LIN_KER_FIRST;
static uint32_t invl_kernel_compid = MTT_CH_LIN_KER_INVALID;
