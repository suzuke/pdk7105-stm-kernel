...
static struct platform_device stih415_ilc3_device = {
	.name		= "ilc3",
	.id		= -1,
	.num_resources	= 2,
	.resource	= (struct resource[]) {
		STM_PLAT_RESOURCE_MEM(0xfde04000, 0x900),
...
static int __init stih415_sh4_devices_setup(void)
{
	return platform_device_register(&stih415_ilc3_device);
}
core_initcall(stih415_sh4_devices_setup);
...
static struct intc_vect stih415_intc_vectors[] = {
...
static struct intc_prio_reg stih415_intc_prio_registers[] = {
					   /*   15-12, 11-8,  7-4,   3-0 */
...
static DECLARE_INTC_DESC(stih415_intc_desc, "stih415",
		stih415_intc_vectors, NULL,
		NULL, stih415_intc_prio_registers, NULL);
