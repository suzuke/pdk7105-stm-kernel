...
#define MTT_API_VER_MINOR	1
#define MTT_API_VERSION	        ((MTT_API_VER_MAJOR<<16)|MTT_API_VER_MINOR)
#define MTT_API_VER_STRING      "MTT API v1.01 build-"__DATE__
...
typedef enum {
	MTT_INIT_LOCAL_TIME = 0x10,
	MTT_INIT_DROP_RECORDS = 0x02,
	MTT_INIT_LOG_LEVEL = 0x04,
	MTT_INIT_CONTEXT = 0x08
} mtt_init_attr_bit_t;
