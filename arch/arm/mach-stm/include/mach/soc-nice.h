...
#define NICE_SBC_LPM_BASE	0xFE400000
#define NICE_SBC_COMMS_BASE	(NICE_SBC_LPM_BASE+0x100000)
#define NICE_SBC_ASC0_BASE	(NICE_SBC_COMMS_BASE+0x30000)

#define NICE_SBC_SYSCONF_BASE	0xFE600000
#define NICE_COMMS_BASE		0xFED00000
#define NICE_ASC0_BASE		(NICE_COMMS_BASE+0x30000)
#define NICE_ASC1_BASE		(NICE_COMMS_BASE+0x31000)
#define NICE_ASC2_BASE		(NICE_COMMS_BASE+0x32000)
#define NICE_ASC3_BASE		(NICE_COMMS_BASE+0x33000)
