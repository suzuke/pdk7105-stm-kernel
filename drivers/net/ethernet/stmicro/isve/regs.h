...
#define DFWD_OUTQ_CTL_REMOVE_SPECIAL_HDR	(1<<21)
...
#define DFWD_QUEUE_IRQ_DISABLE	0xffffffff
#define DFWD_CTRL_DEFAULT	(DFWD_OUTQ_CTL_SWAPOUT | \
				 DFWD_OUTQ_CTL_FREE_FIFO_FULL | \
				 DFWD_OUTQ_CTL_FIFO_THRESH | \
				 DFWD_OUTQ_CTL_REMOVE_DOCSIS_HEADER | \
				 DFWD_OUTQ_CTL_REMOVE_SPECIAL_HDR)
