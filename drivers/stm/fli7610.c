...
static struct stm_pad_config fli7610_mmc_pad_config = {
	.gpios_num = 14,
	.gpios = (struct stm_pad_gpio []) {
		STIH415_PIO_MMC_CLK_OUT(24, 1),
		STIH415_PIO_MMC_BIDIR(24, 2),	/* MMC command */
		STIH415_PIO_MMC_IN(24, 3),	/* MMC Card Detect */
		STIH415_PIO_MMC_BIDIR(24, 4),	/* MMC Data[0]*/
		STIH415_PIO_MMC_BIDIR(24, 5),	/* MMC Data[1]*/
		STIH415_PIO_MMC_BIDIR(24, 6),	/* MMC Data[2]*/
		STIH415_PIO_MMC_BIDIR(24, 7),	/* MMC Data[3]*/
		STIH415_PIO_MMC_BIDIR(25, 0),	/* MMC Data[4]*/
		STIH415_PIO_MMC_BIDIR(25, 1),	/* MMC Data[5]*/
		STIH415_PIO_MMC_BIDIR(25, 2),	/* MMC Data[6]*/
		STIH415_PIO_MMC_BIDIR(25, 3),	/* MMC Data[7]*/
		STIH415_PIO_MMC_IN(25, 4),	/* MMC Write Protection */
		STIH415_PIO_MMC_OUT(25, 6),	/* MMC Card PWR */
		STIH415_PIO_MMC_OUT(25, 7),	/* MMC LED on */
	},
};
