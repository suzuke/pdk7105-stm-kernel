...
static void __init stih415_veloce_map_io(void)
{
	...
	stih415_configure_asc(4, &(struct stih415_asc_config) {
			.routing.asc0 = stih415_asc0_pio0,
			.hw_flow_control = 0,
			.is_console = 1,
			.force_m1 = 1, });
}
...
MACHINE_START(STIH415_VELOCE, "STMicroelectronics STiH415 Veloce")
	.phys_io	= STIH415_SBC_ASC0_BASE,
	.io_pg_offst	= (IO_ADDRESS(STIH415_SBC_ASC0_BASE) >> 18) & 0xfffc,
