/*****************************************************************************
 *
 * File name   : clock-regs-stxmpe42.h
...
#ifndef __CLOCK_LLA_REGS_MPE42_H
#define __CLOCK_LLA_REGS_MPE42_H
...
#define SYS_5000_BASE_ADDRESS		0xFDDF0000
#define SYS_6000_BASE_ADDRESS		0xFD6A0000
#define SYS_7500_BASE_ADDRESS		(0xFDDE0000+0x7D0)
#define SYS_8500_BASE_ADDRESS		(0xFD320000+0x7D0)
#define SYS_9500_BASE_ADDRESS		(0xFD690000+0x7D0)

#define SYS_MALI_BASE_ADDRESS		0xFD68FF00

/* --- CKGA registers --- */
#define CKGA_PLLX_REGY_CFG(_pll, _reg)	\
	(_reg == 3 ? (0x54 + _pll * 4) : (_pll * 0xc + _reg * 4))
...
#endif  /* End __CLOCK_LLA_REGS_MPE42_H */
